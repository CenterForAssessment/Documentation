...
rmarkdown::render(file.path("report", "Colorado_Academic_Impact_Analysis.Rmd"))
pagedown::chrome_print(file.path("report", "Colorado_Academic_Impact_Analysis.html"), wait=10, timeout=60)
...
file.copy(file.path("report", "Colorado_Academic_Impact_Analysis.pdf"), file.path("site", "downloads"), overwrite = TRUE)
