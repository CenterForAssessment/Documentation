...
as priors).
  ...
  A) Assessment Data
      1. ILEARN (status & growth determinations for elementary/middle)
      2. WIDA ACCESS 2.0 (status & growth determinations for English learners)
      3. NWEA formative assessment (status & growth determinations for elementary/middle)
  B) Population Data
      1. Attendance collections
      2. Poverty index data
  C) Technology Data
      1. Annual Tech Plan
  D) Note: indicate limitations or lack of data availability (participation rate)
